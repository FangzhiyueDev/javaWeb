...
var createView = "<div class=\"navigateBarContainer\">\n" +
    ...
    "    </ul>\n" +
    "    <!--用户登录的显示-->\n" +
    "    <div class=\"user\" id=\"userLoginStatus\">\n" +
...
function setLoginStatus(statusBool, userName) {
    ...
    if (statusBool) {//如果已经登录
        var userElement = document.getElementById("userLoginStatus");
        var inner = " <span onclick=\"\">" + userName + "</span>\n" +
            "        /\n" +
            "        <span onclick=\"validate()\"> 注销 </span>\n";
