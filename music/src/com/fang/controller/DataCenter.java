...
public class DataCenter extends HttpServlet {
	 ...
	 * @param classfy
	 */
	private void getClassfyMusicList(HttpServletRequest request, HttpServletResponse response, String classfy) throws Exception {
	 ...
	 * @param musicId
	 */
	private void getMusicDetailInfo(HttpServletRequest request, HttpServletResponse response, String musicId)throws Exception {
